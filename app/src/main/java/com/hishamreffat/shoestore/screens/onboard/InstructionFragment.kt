...
import com.hishamreffat.shoestore.databinding.FragmentInstructionBinding
...
class InstructionFragment : Fragment() {
    override fun onCreateView(
        ...
        binding.finishButton.setOnClickListener { view:View ->
            view.findNavController().navigate(InstructionFragmentDirections.actionInstructionFragmentToShoesListFragment())
        }
        return binding.root
    }
}